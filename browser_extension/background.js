/**
 * background.js — PhishGuard Browser Extension
 * Service worker for context menu URL scanning.
 *
 * API URL is hardcoded because browser extensions don't use Vite bundling.
 * Change this if your backend URL changes.
 */

const API_URL = 'https://phishguard-backend-uc0n.onrender.com';
        ...
        chrome.scripting.executeScript({
          ...
          func: () => {
            ...
            if (t) {
              ...
              t.innerHTML = `PhishGuard Error: Could not connect to the analysis engine.`;
